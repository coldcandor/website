...
/*
$Id: nusoap.php,v 1.91 2005/06/06 21:26:55 snichol Exp $
...
* @version  $Id: nusoap.php,v 1.91 2005/06/06 21:26:55 snichol Exp $
* @access   public
*/
class nusoap_base {
	/**
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=60){
		parent::nusoap_base();
        $this->wsdl = $wsdl;
...
class soapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 60){
		parent::nusoap_base();
