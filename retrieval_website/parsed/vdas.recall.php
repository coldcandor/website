...
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/index.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/index.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse index in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "recall";
$myFusebox['thisCircuit'] = "wrapper";
