...
$myFusebox['thisFuseaction'] = "download";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/act_download.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/act_download.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse act_download in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "download";
$myFusebox['thisCircuit'] = "wrapper";
