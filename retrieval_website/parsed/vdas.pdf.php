...
$myFusebox['thisFuseaction'] = "PDF";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/pdfDocs.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/pdfDocs.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse pdfDocs in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "PDF";
$myFusebox['thisCircuit'] = "wrapper";
