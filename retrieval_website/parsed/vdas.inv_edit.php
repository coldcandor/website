...
$myFusebox['thisFuseaction'] = "inv_edit";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/csv_edit.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/csv_edit.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse csv_edit in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "inv_edit";
$myFusebox['thisCircuit'] = "wrapper";
