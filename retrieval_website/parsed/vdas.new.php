...
$myFusebox['thisFuseaction'] = "new";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/new.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/new.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse new in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "new";
$myFusebox['thisCircuit'] = "wrapper";
