...
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."login/act_Logout.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."login/act_Logout.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse act_Logout in circuit login which does not exist."));
}
$myFusebox['thisCircuit'] = "login";
