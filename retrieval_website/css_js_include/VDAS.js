    ...
    function validateDlSubmit() {
      ...
      if (count > 0 && count <= 100) {
        ...
        alert('No Files were selected!  Please select at least one file before continuing.');
      } else if (count > 100) {
        alert('You\'ve selected ' + count + ' files!  Please select less than 100 files to continue.');
      } // End if - else statement
     ...
     */
    function resetFields() {
      document.forms[0].record.selectedIndex = "0";
      document.forms[0].cell.selectedIndex = "0";
      document.forms[0].engine.selectedIndex = "0";
      document.forms[0].runType.selectedIndex = "0";
      document.forms[0].serial.value = "";
      document.forms[0].build.value = "";
      document.forms[0].run.value = "";
