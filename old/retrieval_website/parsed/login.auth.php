...
$myFusebox['thisFuseaction'] = "checkLogin";
$myFusebox['thisCircuit'] = "login";
$myFusebox['thisFuseaction'] = "auth";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."login/act_authenticate.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."login/act_authenticate.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse act_authenticate in circuit login which does not exist."));
}
...
$myFusebox['thisCircuit'] = "login";
$myFusebox['thisFuseaction'] = "summary";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."login/summary.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."login/summary.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse summary.php in circuit login which does not exist."));
}
$myFusebox['thisCircuit'] = "login";
$myFusebox['thisFuseaction'] = "auth";
}
