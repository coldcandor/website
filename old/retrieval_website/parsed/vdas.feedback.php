...
$myFusebox['thisFuseaction'] = "feedback";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/feedback.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/feedback.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse feedback in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "feedback";
$myFusebox['thisCircuit'] = "wrapper";
