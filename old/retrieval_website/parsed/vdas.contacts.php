...
$myFusebox['thisFuseaction'] = "contacts";
if ( file_exists($application["fusebox"]["WebRootToAppRootPath"]."VDAS/contacts.php") ) {
include($application["fusebox"]["WebRootToAppRootPath"]."VDAS/contacts.php");
}
 else {
__cfthrow(array("type"=>"fusebox.missingFuse", "message"=>"missing Fuse", "detail"=>"You tried to include a fuse contacts in circuit vdas which does not exist."));
}
$myFusebox['thisCircuit'] = "vdas";
$myFusebox['thisFuseaction'] = "contacts";
$myFusebox['thisCircuit'] = "wrapper";
